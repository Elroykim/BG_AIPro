...
2026년 1월 22일, 한국에서 세계 최초로 AI 규제법이 전면 시행됐습니다. 정식 명칭은 「인공지능 발전과 신뢰 기반 조성 등에 관한 기본법」, 줄여서 **AI 기본법**이라고 부릅니다. EU AI Act보다 실제 적용 시점이 빠르다는 점에서 한국이 사실상 세계 최초의 포괄적 AI 규제 시행 국가가 된 셈입니다.

이 글에서는 변호사 언어가 아니라 **개발자와 스타트업 실무자 관점**에서, 이 법이 우리에게 어떤 영향을 주는지 하나씩 풀어보겠습니다.
...
"나는 그냥 코드 짜는 사람인데?" 라고 생각할 수 있습니다. 하지만 이 법의 적용 대상은 생각보다 넓습니다.
...
고영향 AI를 제공하기 전에 기본권 영향 평가(FRIA, Fundamental Rights Impact Assessment)를 수행하도록 권고됩니다. 현재는 법적으로 "노력 의무"로 규정되어 있어 강제는 아니지만, 향후 의무화될 가능성이 있으므로 선제적으로 준비하는 것이 좋습니다.
